...
from pdb2pqr.src.protein import getPDBFile, readPDB, Protein, Amino, Nucleic
from pdb2pqr.src.aa import LIG
from pdb2pqr.src.errors import PDB2PKAError
...
def pre_init(original_pdb_list=None,
    ...
    #
    import pdb2pqr.src.psize
    size = pdb2pqr.src.psize.Psize()
    ...
    #
    igen.pdie = pdie
    print('Setting protein dielectric constant to {}'.format(igen.pdie))
    igen.sdie=sdie
    igen.maps=maps
    if maps==1:
        ...
        print('Setting dielectric function maps: {}, {}, {}'.format(
        ...
        print('Setting mobile ion-accessibility function map to: {}'.format(igen.kappa))
